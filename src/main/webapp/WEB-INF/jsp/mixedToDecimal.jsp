...
<ct:header-css/>
<body>
<ct:header titleKey="mixed.decimal.title"/>
<div align="center">
    <form:form method="post" action="${contextPath}/mixedToDecimal/grade" modelAttribute="exercise">
                        ...
                        <div class="table">
                            <div class="table-row">
                                <div class="table-cell">
                                    <div class="table">
                                        <div class="table-row">
                                            <div class="table-cell whole-number">
                                                <c:out value="${fraction.wholeNumber}"/>
                                            </div>
                                            <div class="table-cell">
                                                <div class="table">
                                                    <div class="table-row">
                                                        <div class="table-cell-border-down small-fraction text-center">
        ...
        <spring:url value="${contextPath}/mixedToDecimal" var="restartURL"/>
        <spring:url value="${contextPath}/mixedToDecimal/verify" var="verifyURL"/>
